...
function addAnchors(a) {
  ...
  if (a) {
    if ("string" != typeof a) throw new Error("AnchorJS accepts only strings; you used a " + _typeof(a));
...
!function (a, b, c) {
...
}(void 0)), document.querySelectorAll || (document.querySelectorAll = function (a) {
  var b,
  ...
  var a = function a() {},
    ...
    if ("object" == _typeof(g)) for (var h in g) {
      f[h] = g[h];
    }
  ...
  var x = "http://www.w3.org/2000/svg",
      y = b.document,
      z = {
    addTheme: function addTheme(a, b) {
    ...
    var c = 1,
      ...
      function c(c, d) {
        if (a.constructor.call(this, c), this.properties = {
          fill: "#000"
        }, null != d) b(this.properties, d);else if (null != c && "string" != typeof c) throw "SceneGraph: invalid node name";
      }
...
!function (a) {
  ...
  K.config = function (a) {
    if ("object" == _typeof(a) && null !== a && D(N, a), "string" != typeof a || !a) {
      var b = {};
