    ...
    // 构造图片和文字数组
    var arr_img = ['../images/1920x650.jpg', '../images/PC轮播1.jpg', '../images/1920x650.jpg'];
    ...
    /* 
        ...
        */
        ...
        //初始化滚动距离
        boxDiv.scrollLeft = imgIndex * imgWidth
        //创建图片和图片的切换函数
        function autoMove() {
            //递增图片下标
            imgIndex++
        ...
        document.onvisibilitychange = function () {
            ...
            if (document.hidden) {
                ...
                //继续图片切换
                dsq1 = setInterval(autoMove, 2000)
            }
        }
        //创建定时器调用切换图片的函数
        dsq1 = setInterval(autoMove, 2000)
        ...
        function move() {
            ...
            dsq2 = setInterval(function () {
                ...
                if (s1 == s2) {
                    clearInterval(dsq2)
                    //直接走到终点
                    boxDiv.scrollLeft = end
                    //重新把bool设置为true，表示图片可以继续切换
                    bool = true
                    return
                }
                //修改当前滚动距离
